...
\ion{C}{2} absorption, and (iv) blue and nearly constant $(B - V)_0$
...
\begin{figure}[]
  ...
  \caption{
  %
  Comparison of the models from \citet{2017MNRAS.472.2787N to the
...
In Figure~\ref{fig:noebauer} we compare photometric observations of
