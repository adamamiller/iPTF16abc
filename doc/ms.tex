...
light for the SN, that is when the SN could have first been detected
by our survey, occurred only $0.15\pm_{0.07}^{0.15}$\,d before our
first detection. In the $\sim$24\,hr after discovery, \abc\ rose by
$\sim$2\,mag, featuring a near-linear rise in flux for $\gtrsim$3 d.
Early spectra show strong \ion{C{2} absorption, which disappears
...
non-evolving blue colors, and (iii) the strong \ion{C{2}} absorption,
are the result of either ejecta interaction with nearby, unbound
