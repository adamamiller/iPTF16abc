...
is mixed and deposited into different layers of the ejecta. Strong
...
larger luminosities and bluer optical colors at early times.
Even with vigorous mixing it is difficult at very early times, $\ll
...
Weak mixing results in redder colors and a more moderate rise in
...
often incorrect by as much as $\sim$2\,d using common methods in the
...
the \ion{Ca}{2}\,H$+$K and \ion{Na}{1}\,D doublets. Despite large
...
In Figure~\ref{fig:branch_vel, the velocity evolution of the \abc\
...
Following Arnett's rule \citep{1982ApJ...253..785A,
